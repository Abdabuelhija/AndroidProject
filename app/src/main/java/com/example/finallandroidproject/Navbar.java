...
import com.example.finallandroidproject.databinding.ActivityNavbarBinding;
...
public class Navbar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(R.id.nav_home, R.id.nav_allwatches, R.id.nav_cart,R.id.nav_contactus).setOpenableLayout(drawer).build();
